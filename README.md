...
### get_precedence <kbd>method</kbd>

```python (doc)
MathExpression.get_precedence(self) -> mathy_core.expressions.Precedence
```

Get the precedence level of this expression
...
### needs_parentheses <kbd>method</kbd>

```python (doc)
MathExpression.needs_parentheses(
    self,
...
Determine if this expression needs parentheses when printed as a child of parent
...
## OperatorInfo <kbd>dataclass</kbd>

```python (doc)
OperatorInfo(
    self,
    precedence: mathy_core.expressions.Precedence,
    symbol: str,
...
Information about an operator's properties
...
## Precedence <kbd>class</kbd>

```python (doc)
Precedence(self, args, kwargs)
```

Operator precedence levels from highest (lowest number) to lowest (highest number)
